...
class ReportePlanilla2
{
	public $id;

	public function traerImpresionPlanilla2()
	{
		$idItem = "idplanilla";
		$idValor = $this->id;
    ...
    ';
		...
		$pdf->Output('reporte_planilla.pdf', 'I');
	}
...
$planilla = new ReportePlanilla2();
$planilla->id = $_GET["id"];
$planilla->traerImpresionPlanilla2();
