                    ...
                    <div class="box-body">
                      ...
                      <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control input-lg" name="idventapago" id="idventapago" placeholder="Ingresar ID de Venta" required readonly>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control input-lg" name="nuevoFecha" id="nuevoFecha" required>
                            </div>
                        </div>
