...
<head>
  ...
  <!-- Bootstrap Css -->
  <link href="vistas/assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
  <!-- Icons Css -->
  <link href="vistas/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
  <!-- App Css-->
  <link href="vistas/assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
                ...
                <div class="col-lg-9">
                  <div>
                    <div class="text-center">
                      <div>
                        <a href="#" class="">
                          <img src="vistas/assets/images/m.png" alt="" height="60" class="auth-logo logo-dark mx-auto">
                         
                        </a>
                      </div>

                      <h4 class="font-size-18 mt-4">B I E N V E N I D O</h4>
                    ...
                    <div class="p-2 mt-5">
                      <form method="post">
                        ...
                        <div class=" form-group has-feedback mb-3 auth-form-group-custom mb-4">
                    ...
                    <div class="mt-5 text-center">
                      ...
                      <p>© <script>
                        ...
                        </script> Sistema Muebleria A.F. Crafted with </i> by muebleria productions</p>
                    </div>
                  </div>
                </div>
              </div>
