...
class ControladorVentas{
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($_POST["listaProductos"] == ""){
				...
				swal({
					  type: "error",
					  title: "La venta o pedido no se ha ejecuta si no hay productos",
			...
			if($respuesta == "ok"){
				...
				swal({
					  type: "success",
					  title: "La venta o pedido ha sido guardado correctamente",
					  showConfirmButton: true,
					  confirmButtonText: "Cerrar"
					  }).then(function(result){
								if (result.value) {
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			if($respuesta == "ok"){
				...
				swal({
					  type: "success",
					  title: "La venta o pedido ha sido editado correctamente",
					  showConfirmButton: true,
					  confirmButtonText: "Cerrar"
					  }).then((result) => {
								if (result.value) {
	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			if($respuesta == "ok"){
				...
				swal({
					  type: "success",
					  title: "La venta o pedido ha sido borrado correctamente",
					  showConfirmButton: true,
					  confirmButtonText: "Cerrar"
					  }).then(function(result){
								if (result.value) {
	...
	static public function ctrMostrarVentasPagos(){


		$respuesta = ModeloVentas::mdlMostrarVentasPagos();

		return $respuesta;
		
	}

	static public function ctrMostrarDetallePago(){

		$respuesta = ModeloVentas::mdlMostrarDetallePago();
	...
	public static function ctrActualizarEstadoVenta($idVenta, $nuevoEstado) {
		$tablaVentas = "ventas";
		$tablaVentasPagos = "ventaspagos";

		// Actualizar el estado en la tabla de ventas
		ModeloVentas::mdlActualizarEstado($tablaVentas, $idVenta, $nuevoEstado);

		// Actualizar el estado en la tabla de ventaspagos
		ModeloVentas::mdlActualizarEstado($tablaVentasPagos, $idVenta, $nuevoEstado);
	}
